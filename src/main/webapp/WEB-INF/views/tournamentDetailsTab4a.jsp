...
<div id="tab4a" class="${isSWN }">
                                                	...
                                                	<form:form action="${addAction}" commandName="tournamentDetailsNWomans" name="tournamentDetailsNWomans" id="tournamentDetailsNWomans" modelAttribute="tournamentDetailsNWomans">
	                                                	...
	                                                	<div class="captura-center-content">
																<div class="form-group">
					                                                ...
					                                                <div class="btn-group" >
					                                                	...
					                                                	<form:radiobutton path="format" value="RR" id="RRRBNW" onchange="javascript:radioChangedNW();"/>Round Robbin </label>
					                                                	<label class="btn btn-primary">
					                                                	<form:radiobutton path="format" value="MD" id="MDRBNW" onchange="javascript:radioChangedNW();"/>Main Draw </label>
					                                                </div>
					                                            </div>
					                                     </div>
					                                     <div class="captura-right-content">
				                                     ...
				                                     <div class="captura-right-content">
				                                     	<div class="form-group ${hasError}">
																	<label class="col-sm-2 control-label">* <spring:message code="tournamentDetails.match" /></label>
																		<div class="col-sm-4">
																			<form:select path="matchDuration" name="matchDurationNW" id="matchDurationNW" class="form-control" >
				                                     ...
				                                     <div class="captura-right-content">
														<spring:bind path="drawSize">
														  <div class="form-group ${hasError} ">
															...
															<div class="col-sm-1">
																<c:choose>
																	<c:when test="${tournamentDetailsNWomans.format eq 'MD' }">
																		<form:input path="drawSize" class="form-control" id="drawSizeNW"  disabled="false"/>
																	</c:when>
																	<c:otherwise>
																		<form:input path="drawSize" class="form-control" id="drawSizeNW"  disabled="true"/>
																	</c:otherwise>
																</c:choose>
														...
														<spring:bind path="groupsSize">
														  <div class="form-group ${hasError} ">
															...
															<div class="col-sm-1">
																<c:choose>
																	<c:when test="${tournamentDetailsNWomans.format eq 'MD' }">
																		<form:input path="groupsSize" class="form-control" id="groupsSizeNW"  disabled="true"/>
																	</c:when>
																	<c:otherwise>
																		<form:input path="groupsSize" class="form-control" id="groupsSizNW"  disabled="false"/>
																	</c:otherwise>
																</c:choose>
				                                     	...
				                                     	<div class="form-group ${hasError}">
																	<label class="col-sm-2 control-label"><spring:message code="tournamentDetails.seconds" /></label>
																		<div class="col-sm-2">
																			<c:choose>
																			<c:when test="${tournamentDetailsNWomans.format eq 'MD' }">
																				<form:select path="advanceSecond" name="advanceSecond" id="advanceSecondNW" class="form-control" disabled="true" >
																			...
																			<c:otherwise>
																				<form:select path="advanceSecond" name="advanceSecond" id="advanceSecondNW" class="form-control" disabled="false"  >
																				<form:option value="0" selected="selected"><spring:message code="tournamentDetails.none" /></form:option>
																				<form:option value="9"><spring:message code="tournamentDetails.all" /></form:option>
																				<form:option value="1"><spring:message code="tournamentDetails.1" /></form:option>
																				<form:option value="2"><spring:message code="tournamentDetails.2" /></form:option>
                                                					...
                                                					<label class="col-sm-2 control-label"><spring:message code="tournamentDetails.thirds" /></label>
																		<div class="col-sm-2">
																			<c:choose>
																			<c:when test="${tournamentDetailsNWomans.format eq 'MD' }">
																				<form:select path="advanceThird" name="advanceThird" id="advanceThirdNW" class="form-control" disabled="true" >
																				<form:option value="0" selected="selected"><spring:message code="tournamentDetails.none" /></form:option>
																				<form:option value="9"><spring:message code="tournamentDetails.all" /></form:option>
																				<form:option value="1"><spring:message code="tournamentDetails.1" /></form:option>
																				<form:option value="2"><spring:message code="tournamentDetails.2" /></form:option>
																			...
																			<c:otherwise>
																				<form:select path="advanceThird" name="advanceThird" id="advanceThirdNW" class="form-control" disabled="false"  >
																				<form:option value="0" selected="selected"><spring:message code="tournamentDetails.none" /></form:option>
																				<form:option value="9"><spring:message code="tournamentDetails.all" /></form:option>
																				<form:option value="1"><spring:message code="tournamentDetails.1" /></form:option>
																				<form:option value="2"><spring:message code="tournamentDetails.2" /></form:option>
													...
													<div class="captura-right-content">
													 ...
													 <div class="captura-right-content" >
				                                     	<div class="form-group ${hasError}">
																	<label class="col-sm-2 control-label">* <spring:message code="tournamentDetails.categoriesRel" /></label>
																		<div class="col-sm-4">
																			<form:select path="categories" name="categoriesNW" id="categoriesNW" multiple="true" class="form-control" >
																				<c:forEach var="tp" items="${nvwomansCategoriesS}">
																					<c:choose>
																						<c:when test="${fn:contains(selectedCategoriesSWN, tp.name)}">
				                                     ...
				                                     <table>
														<tr>
															<td colspan="2">
																	<input class="pl-point-button" type="submit"
																		value="<spring:message code="greenBall.guardar"/>"  name="SWN"/>
																	<input class="pl-point-button" type="submit"
														...
														<c:forEach items="${tournamentDetailsSWN}" var="configura">
															<tr>
																<td>${configura.id}</td>
