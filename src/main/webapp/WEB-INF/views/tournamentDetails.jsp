...
<c:url var="addAction" value="/${shortName}/addTournamentDetails" ></c:url>
     ...
     <section id="single-match-pl" class="container secondary-page">
      <div class="general general-results players">
           <div class="top-score-title right-score col-md-16">
                ...
                <h3><spring:message code="tournamentDetails" /><span class="point-little">.</span></h3>
                <p style="text-align:center;"><img alt="" src="<%=pathGreenBall%>/resources/images/draws/drawsState2.png" align="middle" ></p>
                <div class="main">
                       <div class="tabs standard single-pl">
           				...
           				<p><input class="pl-point-button" type="button" name="uploadFile" onclick="window.location.href='<%=pathGreenBall%>/${shortName}/categories'"
							value="<spring:message code="prev.categories"/>" />
							<input style="float: right;" class="pl-point-button" type="button" name="uploadFile" onclick="window.location.href='<%=pathGreenBall%>/${shortName}/players'"
							value="<spring:message code="next.players"/>" />
							</p>
           			</div>
         		 </div>
         	</div>
