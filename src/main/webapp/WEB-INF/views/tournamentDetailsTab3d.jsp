...
<c:url var="addAction" value="/addTournamentDetails" ></c:url>
 <c:choose>
                                                ...
                                                <div id="tab3d" class="${isDMN}">
                                                	<form:form action="${addAction}" commandName="tournamentDetailsNMensD" name="tournamentDetailsNMensD" id="tournamentDetailsNMensD" modelAttribute="tournamentDetailsNMensD">
	                                                	...
	                                                	<div class="captura-center-content">
																<div class="form-group">
					                                                ...
					                                                <div class="btn-group" >
					                                                	...
					                                                	<form:radiobutton path="format" value="RR" id="RRRBNMD" onchange="javascript:radioChangedNMD();"/>Round Robbin </label>
					                                                	<label class="btn btn-primary">
					                                                	<form:radiobutton path="format" value="MD" id="MDRBNMD" onchange="javascript:radioChangedNMD();"/>Main Draw </label>
					                                                </div>
					                                            </div>
					                                     </div>
					                                     <div class="captura-right-content">
				                                     ...
				                                     <div class="captura-right-content">
				                                     	<div class="form-group ${hasError}">
																	<label class="col-sm-2 control-label">* <spring:message code="tournamentDetails.match" /></label>
																		<div class="col-sm-4">
																			<form:select path="matchDuration" name="matchDurationNMD" id="matchDurationNMD" class="form-control" >
				                                     ...
				                                     <div class="captura-right-content">
														<spring:bind path="drawSize">
														  <div class="form-group ${hasError} ">
															...
															<div class="col-sm-1">
																<c:choose>
																	<c:when test="${tournamentDetailsNMensD.format eq 'DMN' }">
																		<form:input path="drawSize" class="form-control" id="drawSizeNMD"  disabled="false" />
																	</c:when>
																	<c:otherwise>
																		<form:input path="drawSize" class="form-control" id="drawSizeNMD"  disabled="true" />
																	</c:otherwise>
																</c:choose>
														...
														<spring:bind path="groupsSize">
														  <div class="form-group ${hasError} ">
															...
															<div class="col-sm-1">
																<c:choose>
																	<c:when test="${tournamentDetailsNMensD.format eq 'DMN' }">
																		<form:input path="groupsSize" class="form-control" id="groupsSizeNMD"  disabled="true"/>
																	</c:when>
																	<c:otherwise>
																		<form:input path="groupsSize" class="form-control" id="groupsSizeNMD"  disabled="false"/>
																	</c:otherwise>
																</c:choose>
													...
													<div class="captura-right-content">
				                                     	<div class="form-group ${hasError}">
																	<label class="col-sm-2 control-label"><spring:message code="tournamentDetails.seconds" /></label>
																		...
																		<c:choose>
																			<c:when test="${tournamentDetailsNMensD.format eq 'DMN' }">
																				<form:select path="advanceSecond" name="advanceSecondNMD" id="advanceSecondNMD" class="form-control" disabled="true" >
																			...
																			<c:otherwise>
																				<form:select path="advanceSecond" name="advanceSecondNMD" id="advanceSecondNMD" class="form-control" disabled="false"  >
																				<form:option value="0" selected="selected"><spring:message code="tournamentDetails.none" /></form:option>
																				<form:option value="9"><spring:message code="tournamentDetails.all" /></form:option>
																				<form:option value="1"><spring:message code="tournamentDetails.1" /></form:option>
																				<form:option value="2"><spring:message code="tournamentDetails.2" /></form:option>
                                                					...
                                                					<label class="col-sm-2 control-label"><spring:message code="tournamentDetails.thirds" /></label>
																		<div class="col-sm-2">
																			<c:choose>
																			<c:when test="${tournamentDetailsNMensD.format eq 'DMN' }">
																				<form:select path="advanceThird" name="advanceThirdNMD" id="advanceThirdNMD" class="form-control" disabled="true"  >
																				<form:option value="0" selected="selected"><spring:message code="tournamentDetails.none" /></form:option>
																				<form:option value="9"><spring:message code="tournamentDetails.all" /></form:option>
																				<form:option value="1"><spring:message code="tournamentDetails.1" /></form:option>
																				<form:option value="2"><spring:message code="tournamentDetails.2" /></form:option>
																			...
																			<c:otherwise>
																				<form:select path="advanceThird" name="advanceThirdNMD" id="advanceThirdNMD" class="form-control" disabled="false" >
																				<form:option value="0" selected="selected"><spring:message code="tournamentDetails.none" /></form:option>
																				<form:option value="9"><spring:message code="tournamentDetails.all" /></form:option>
																				<form:option value="1"><spring:message code="tournamentDetails.1" /></form:option>
																				<form:option value="2"><spring:message code="tournamentDetails.2" /></form:option>
													...
													<div class="captura-right-content">
													 ...
													 <div class="captura-right-content" >
				                                     	<div class="form-group ${hasError}">
																	<label class="col-sm-2 control-label">* <spring:message code="tournamentDetails.categoriesRel" /></label>
																		<div class="col-sm-4">
																			<form:select path="categories" name="categoriesNMD" id="categoriesNMD" multiple="true" class="form-control" >
																				<c:forEach var="tp" items="${nvmensCategoriesD}">
																					<c:choose>
																						<c:when test="${fn:contains(selectedCategoriesDMN, tp.name)}">
				                                     ...
				                                     <table>
														<tr>
															<td colspan="2">
																	<input class="pl-point-button" type="submit"
																		value="<spring:message code="greenBall.guardar"/>"  name="DMN"/>
																	<input class="pl-point-button" type="submit"
														...
														<c:forEach items="${tournamentDetailsDMN}" var="configura">
															<tr>
																<td>${configura.id}</td>
