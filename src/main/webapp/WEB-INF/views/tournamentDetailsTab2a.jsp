...
<c:url var="addAction" value="/addTournamentDetails" ></c:url>
 <c:choose>
                                            	...
                                            	<div id="tab2a" class="${isSW}">
                                            	
                                                	<form:form action="${addAction}" commandName="tournamentDetailsWomans" name="tournamentDetailsWomans" id="tournamentDetailsWomans" modelAttribute="tournamentDetailsWomans">
	                                                	...
	                                                	<div class="captura-center-content">
																<div class="form-group">
					                                                ...
					                                                <div class="btn-group" >
				                                                		...
				                                                		<form:radiobutton path="format" value="RR" id="RRRBW" onchange="javascript:radioChangedW();"/>Round Robbin </label>
				                                                		<label class="btn btn-primary">
				                                                		<form:radiobutton path="format" value="MD" id="MDRBW" onchange="javascript:radioChangedW();"/>Main Draw </label>
				                                     ...
				                                     <div class="captura-right-content">
				                                     	<div class="form-group ${hasError}">
																	<label class="col-sm-2 control-label">* <spring:message code="tournamentDetails.match" /></label>
																		<div class="col-sm-4">
																			<form:select path="matchDuration" name="matchDuration" id="matchDurationW" class="form-control" >
				                                     ...
				                                     <div class="captura-right-content">
														<spring:bind path="drawSize">
														  <div class="form-group ${hasError} ">
															...
															<div class="col-sm-1">
																<c:choose>
																	<c:when test="${tournamentDetailsWomans.format eq 'MD' }">
																		<form:input path="drawSize" class="form-control" id="drawSizeW"  disabled="false"/>
																	</c:when>
																	<c:otherwise>
																		<form:input path="drawSize" class="form-control" id="drawSizeW"  disabled="true"/>
																	</c:otherwise>
																</c:choose>
														...
														<spring:bind path="groupsSize">
														  <div class="form-group ${hasError} ">
															...
															<div class="col-sm-1">
																<c:choose>
																	<c:when test="${tournamentDetailsWomans.format eq 'MD' }">
																		<form:input path="groupsSize" class="form-control" id="groupsSizeW"  disabled="true"/>
																	</c:when>
																	<c:otherwise>
																		<form:input path="groupsSize" class="form-control" id="groupsSizeW"  disabled="false"/>
																	</c:otherwise>
																</c:choose>
													...
													<div class="captura-right-content">
				                                     	<div class="form-group ${hasError}">
																	<label class="col-sm-2 control-label"><spring:message code="tournamentDetails.seconds" /></label>
																		<div class="col-sm-2">
																			<c:choose>
																			<c:when test="${tournamentDetailsWomans.format eq 'MD' }">
																				<form:select path="advanceSecond" name="advanceSecond" id="advanceSecondW" class="form-control" disabled="true" >
																			...
																			<c:otherwise>
																				<form:select path="advanceSecond" name="advanceSecond" id="advanceSecondW" class="form-control" disabled="false"  >
																				<form:option value="0" selected="selected"><spring:message code="tournamentDetails.none" /></form:option>
																				<form:option value="9"><spring:message code="tournamentDetails.all" /></form:option>
																				<form:option value="1"><spring:message code="tournamentDetails.1" /></form:option>
																				<form:option value="2"><spring:message code="tournamentDetails.2" /></form:option>
                                                					...
                                                					<label class="col-sm-2 control-label"><spring:message code="tournamentDetails.thirds" /></label>
																		<div class="col-sm-2">
																			<c:choose>
																			<c:when test="${tournamentDetailsWomans.format eq 'MD' }">
																				<form:select path="advanceThird" name="advanceThird" id="advanceThirdW" class="form-control" disabled="true" >
																				<form:option value="0" selected="selected"><spring:message code="tournamentDetails.none" /></form:option>
																				<form:option value="9"><spring:message code="tournamentDetails.all" /></form:option>
																				<form:option value="1"><spring:message code="tournamentDetails.1" /></form:option>
																				<form:option value="2"><spring:message code="tournamentDetails.2" /></form:option>
																			...
																			<c:otherwise>
																				<form:select path="advanceThird" name="advanceThird" id="advanceThirdW" class="form-control" disabled="false"  >
																				<form:option value="0" selected="selected"><spring:message code="tournamentDetails.none" /></form:option>
																				<form:option value="9"><spring:message code="tournamentDetails.all" /></form:option>
																				<form:option value="1"><spring:message code="tournamentDetails.1" /></form:option>
																				<form:option value="2"><spring:message code="tournamentDetails.2" /></form:option>
																	...
																	<label class="col-sm-2 control-label">* <spring:message code="tournamentDetails.categoriesRel" /></label>
																		<div class="col-sm-4">
																			<form:select path="categories" name="categories" id="categoriesW" multiple="true" class="form-control" >
																				<c:forEach var="tp" items="${womansCategoriesS}">
																					<c:choose>
																						<c:when test="${fn:contains(selectedCategoriesSW, tp.name)}">
				                                     ...
				                                     <table>
														<tr>
															<td colspan="2">
																	<input class="pl-point-button" type="submit"
																		value="<spring:message code="greenBall.guardar"/>"  name="W"/>
																	<input class="pl-point-button" type="submit"
														...
														<c:forEach items="${tournamentDetailsSW}" var="configura">
															<tr>
																<td>${configura.id}</td>
