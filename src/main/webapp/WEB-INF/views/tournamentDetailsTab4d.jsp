...
<c:url var="addAction" value="/addTournamentDetails" ></c:url>
 <c:choose>
                                                ...
                                                <div id="tab4d" class="${isDWN }">
                                                	<form:form action="${addAction}" commandName="tournamentDetailsNWomansD" name="tournamentDetailsNWomansD" id="tournamentDetailsNWomansD" modelAttribute="tournamentDetailsNWomansD">
		                                                	...
		                                                	<div class="captura-center-content">
																	<div class="form-group">
						                                                ...
						                                                <div class="btn-group" >
						                                                	...
						                                                	<form:radiobutton path="format" value="RR" id="RRRBNWD" onchange="javascript:radioChangedNWD();"/>Round Robbin </label>
						                                                	<label class="btn btn-primary">
						                                                	<form:radiobutton path="format" value="MD" id="MDRBNWD" onchange="javascript:radioChangedNWD();"/>Main Draw </label>
						                                                </div>
						                                            </div>
						                                     </div>
						                                     <div class="captura-right-content">
					                                     ...
					                                     <div class="captura-right-content">
					                                     	<div class="form-group ${hasError}">
																		<label class="col-sm-2 control-label">* <spring:message code="tournamentDetails.match" /></label>
																			<div class="col-sm-4">
																				<form:select path="matchDuration" name="matchDurationNWD" id="matchDurationNWD" class="form-control" >
					                                     ...
					                                     <div class="captura-right-content">
															<spring:bind path="drawSize">
															  <div class="form-group ${hasError} ">
																...
																<div class="col-sm-1">
																	<c:choose>
																		<c:when test="${tournamentDetailsNWomansD.format eq 'DWN' }">
																			<form:input path="drawSize" class="form-control" id="drawSizeNWD"  disabled="false" />
																		</c:when>
																		<c:otherwise>
																			<form:input path="drawSize" class="form-control" id="drawSizeNWD"  disabled="true" />
																		</c:otherwise>
																	</c:choose>
															...
															<spring:bind path="groupsSize">
															  <div class="form-group ${hasError} ">
																...
																<div class="col-sm-1">
																	<c:choose>
																		<c:when test="${tournamentDetailsNWomansD.format eq 'DWN' }">
																			<form:input path="groupsSize" class="form-control" id="groupsSizeNWD"  disabled="true"/>
																		</c:when>
																		<c:otherwise>
																			<form:input path="groupsSize" class="form-control" id="groupsSizeNWD"  disabled="false"/>
																		</c:otherwise>
																	</c:choose>
														...
														<div class="captura-right-content">
					                                     	<div class="form-group ${hasError}">
																		<label class="col-sm-2 control-label"><spring:message code="tournamentDetails.seconds" /></label>
																			...
																			<c:choose>
																				<c:when test="${tournamentDetailsNWomansD.format eq 'DWN' }">
																					<form:select path="advanceSecond" name="advanceSecondNWD" id="advanceSecondNWD" class="form-control" disabled="true" >
																				...
																				<c:otherwise>
																					<form:select path="advanceSecond" name="advanceSecondNWD" id="advanceSecondNWD" class="form-control" disabled="false"  >
																					<form:option value="0" selected="selected"><spring:message code="tournamentDetails.none" /></form:option>
																				<form:option value="9"><spring:message code="tournamentDetails.all" /></form:option>
																				<form:option value="1"><spring:message code="tournamentDetails.1" /></form:option>
																				<form:option value="2"><spring:message code="tournamentDetails.2" /></form:option>
	                                                					...
	                                                					<label class="col-sm-2 control-label"><spring:message code="tournamentDetails.thirds" /></label>
																			<div class="col-sm-2">
																				<c:choose>
																				<c:when test="${tournamentDetailsNWomansD.format eq 'DWN' }">
																					<form:select path="advanceThird" name="advanceThirdNWD" id="advanceThirdNWD" class="form-control" disabled="true"  >
																					<form:option value="0" selected="selected"><spring:message code="tournamentDetails.none" /></form:option>
																				<form:option value="9"><spring:message code="tournamentDetails.all" /></form:option>
																				<form:option value="1"><spring:message code="tournamentDetails.1" /></form:option>
																				<form:option value="2"><spring:message code="tournamentDetails.2" /></form:option>
																				...
																				<c:otherwise>
																					<form:select path="advanceThird" name="advanceThirdNWD" id="advanceThirdNWD" class="form-control" disabled="false" >
																					<form:option value="0" selected="selected"><spring:message code="tournamentDetails.none" /></form:option>
																				<form:option value="9"><spring:message code="tournamentDetails.all" /></form:option>
																				<form:option value="1"><spring:message code="tournamentDetails.1" /></form:option>
																				<form:option value="2"><spring:message code="tournamentDetails.2" /></form:option>
														...
														<div class="captura-right-content">
														 ...
														 <div class="captura-right-content" >
					                                     	<div class="form-group ${hasError}">
																		<label class="col-sm-2 control-label">* <spring:message code="tournamentDetails.categoriesRel" /></label>
																			<div class="col-sm-4">
																				<form:select path="categories" name="categoriesNWD" id="categoriesNWD" multiple="true" class="form-control" >
																					<c:forEach var="tp" items="${nvwomansCategoriesD}">
																						<c:choose>
																							<c:when test="${fn:contains(selectedCategoriesDWN, tp.name)}">
					                                     ...
					                                     <table>
															<tr>
																<td colspan="2">
																		<input class="pl-point-button" type="submit"
																			value="<spring:message code="greenBall.guardar"/>"  name="DWN"/>
																		<input class="pl-point-button" type="submit"
															...
															<c:forEach items="${tournamentDetailsDWN}" var="configura">
																<tr>
																	<td>${configura.id}</td>
